...
public extension UIEdgeInsets {
	public static func horizontal(_ padding: CGFloat) -> UIEdgeInsets {
		UIEdgeInsets(top: 0, left: padding, bottom: 0, right: padding)
	}
	
	public static func vertical(_ padding: CGFloat) -> UIEdgeInsets {
		UIEdgeInsets(top: padding, left: 0, bottom: padding, right: 0)
	}
	
	public static func top(_ padding: CGFloat) -> UIEdgeInsets {
		UIEdgeInsets(top: padding, left: 0, bottom: 0, right: 0)
	}
	
	public static func left(_ padding: CGFloat) -> UIEdgeInsets {
		UIEdgeInsets(top: 0, left: padding, bottom: 0, right: 0)
	}
	
	public static func bottom(_ padding: CGFloat) -> UIEdgeInsets {
		UIEdgeInsets(top: 0, left: 0, bottom: padding, right: 0)
	}
	
	public static func right(_ padding: CGFloat) -> UIEdgeInsets {
...
extension UIEdgeInsets {
	static private func +(lhs: UIEdgeInsets, rhs: Double) -> UIEdgeInsets {
		UIEdgeInsets(
			top: lhs.top + rhs,
			left: lhs.left + rhs,
	...
	static private func +(lhs: UIEdgeInsets, rhs: UIEdgeInsets) -> UIEdgeInsets {
		UIEdgeInsets(
			top: lhs.top + rhs.top,
